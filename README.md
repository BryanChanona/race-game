...
gofunc (m *RaceManager) StartRace() {
...
bashgo mod download
3. Ejecutar el juego:
bashgo run src/main.go

 Uso
Controles
TeclaAcciónESPACIOIniciar carrera desde el menúRReiniciar carrera después de terminarESCSalir del juego
Flujo del Juego
